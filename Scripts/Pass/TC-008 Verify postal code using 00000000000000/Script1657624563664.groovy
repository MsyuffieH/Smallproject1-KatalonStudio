...
WebUI.click(findTestObject('Customer details/Postal code (customer details)'))

WebUI.clearText(findTestObject('Customer details/Postal code (customer details)'))

WebUI.sendKeys(findTestObject('Customer details/Postal code (customer details)'), '00000000000000000000000')
