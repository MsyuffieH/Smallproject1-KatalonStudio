...
WebUI.setText(findTestObject('Field/credit card number'), '4911111111111113')

WebUI.setText(findTestObject('Field/Expiration date field'), '0125')

WebUI.setText(findTestObject('Field/CVV field'), '123')
...
WebUI.verifyElementText(findTestObject('Warning message/warning error message'), 'Card declined by bank')

WebUI.verifyElementText(findTestObject('Warning message/Failed to process payment. Please place your order again'), 'Failed to process payment. Please place your order again.')

WebUI.click(findTestObject('Button/Button OK'))

WebUI.switchToDefaultContent()

WebUI.verifyElementPresent(findTestObject('Warning message/Warning sorry something'), 0)
