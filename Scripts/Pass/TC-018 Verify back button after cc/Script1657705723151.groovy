...
WebUI.click(findTestObject('Button/Button Back'))

WebUI.verifyElementText(findTestObject('Verify/Cancel payment using this method'), 'Cancel payment using this method?')

WebUI.verifyElementText(findTestObject('Verify/If cancelled, all filled information will not be saved'), 'If cancelled, all filled information will not be saved.')

WebUI.click(findTestObject('Button/Button yes, cancel'))
