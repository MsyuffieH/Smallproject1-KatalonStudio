...
WebUI.scrollToElement(findTestObject('promo field/Potongan 10 persen'), 0)

WebUI.click(findTestObject('Button/Button potongan 10 persen'))

WebUI.verifyElementText(findTestObject('Verify/verify promo'), 'Rp18.000')
...
WebUI.sendKeys(findTestObject('Field/Password field'), '112233')
