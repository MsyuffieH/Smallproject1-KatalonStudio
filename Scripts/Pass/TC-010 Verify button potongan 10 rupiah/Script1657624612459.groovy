...
WebUI.scrollToElement(findTestObject('promo field/Potongan 10 rupiah'), 0)

WebUI.click(findTestObject('Button/Button potongan 10 rupiah'))

WebUI.verifyElementText(findTestObject('Verify/verify promo'), 'Rp19.990')
